...
const mostBlogs = (blogs) => {
  ...
  const authorName = Object.keys(blogCounts).find(key => blogCounts[key] === maxBlogsNum);
...
const mostLikes = (blogs) => {
  ...
  const authorToReturn = Object.keys(likeCount).find(author => likeCount[author] === maxLikes);
